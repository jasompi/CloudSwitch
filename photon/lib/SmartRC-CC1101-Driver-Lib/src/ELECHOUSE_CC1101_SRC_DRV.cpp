...
if (MHz >= 300 && MHz <= 348){
SpiWriteReg(CC1101_FSCTRL0, (byte)map((double)MHz, 300.0, 348.0, (double)clb1[0], (double)clb1[1]));
...
SpiWriteReg(CC1101_FSCTRL0, (byte)map((double)MHz, 378.0, 464.0, (double)clb2[0], (double)clb2[1]));
...
SpiWriteReg(CC1101_FSCTRL0, (byte)map((double)MHz, 779.0, 899.0, (double)clb3[0], (double)clb3[1]));
...
SpiWriteReg(CC1101_FSCTRL0, (byte)map((double)MHz, 900.0, 928.0, (double)clb4[0], (double)clb4[1]));
SpiWriteReg(CC1101_TEST0,0x09);
int s = ELECHOUSE_cc1101.SpiReadStatus(CC1101_FSCAL2);
if (s<32){SpiWriteReg(CC1101_FSCAL2, s+32);}
